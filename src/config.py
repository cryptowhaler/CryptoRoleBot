...
arg_parser.add("-p", "--command_prefix", default="$", help="The symbol used before commands")
arg_parser.add( "-d","--database_connection",default="sqlite:///data.db",help="An SQLAlchemy connection string",)
